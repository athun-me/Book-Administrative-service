...
type ChangePassworResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ChangePassworResponse) Reset() {
	*x = ChangePassworResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ChangePassworResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChangePassworResponse) ProtoMessage() {}

func (x *ChangePassworResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_pb_admin_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChangePassworResponse.ProtoReflect.Descriptor instead.
func (*ChangePassworResponse) Descriptor() ([]byte, []int) {
	return file_pkg_pb_admin_proto_rawDescGZIP(), []int{2}
}

func (x *ChangePassworResponse) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *ChangePassworResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
var file_pkg_pb_admin_proto_rawDesc = []byte{
	...
	0x63, 0x63, 0x65, 0x73, 0x73, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x45, 0x0a, 0x15, 0x43, 0x68,
	0x61, 0x6e, 0x67, 0x65, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x32, 0x94, 0x01, 0x0a, 0x0c, 0x41, 0x64, 0x6d, 0x69, 0x6e,
	...
	0x1c, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x61,
	...
	0x77, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0a, 0x5a,
...
var file_pkg_pb_admin_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_pkg_pb_admin_proto_goTypes = []interface{}{
	...
	(*ChangePassworResponse)(nil), // 2: admin.ChangePassworResponse
...
var file_pkg_pb_admin_proto_depIdxs = []int32{
	...
	3, // 1: admin.AdminService.ChangePassword:input_type -> admin.ChangePasswordRequest
	1, // 2: admin.AdminService.Login:output_type -> admin.LoginResponse
	2, // 3: admin.AdminService.ChangePassword:output_type -> admin.ChangePassworResponse
...
func file_pkg_pb_admin_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_pb_admin_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChangePassworResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
